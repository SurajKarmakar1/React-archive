...
// rfce    , react snippet generations
//function Card({username}) , we can use directly like this too
function Card(props) {
  return (
    <div class=" relative grid min-h-screen grid-cols-[1fr_2.5rem_auto_2.5rem_1fr] grid-rows-[1fr_1px_auto_1px_1fr] bg-white [--pattern-fg:var(--color-gray-950)]/5 dark:bg-gray-950 dark:[--pattern-fg:var(--color-white)]/10 font-mono font-bold">
      <div class="col-start-3 row-start-3 flex max-w-lg flex-col bg-gray-100 p-2 dark:bg-white/10">
        <div class="rounded-xl bg-white p-10 text-sm/7 text-gray-700 dark:bg-gray-950 dark:text-gray-300">
          <h1 className="text-4xl mb-5 font-mono">{props.cardversion}</h1>
          <div class="space-y-6">
            <p>
            ...
            <ul class="space-y-3">
              <li class="flex">
                ...
                <p class="ml-3">
                  ...
                  <code class="font-mono font-medium text-gray-950 dark:text-white">
                    @theme
                  </code>
                </p>
              </li>
